# Olá, eu sou o Victor Hugo Sagres! 👋

### 👨‍💻 Sobre Mim
- 🎓 Estudante de **Análise e Desenvolvimento de Sistemas** (1º Semestre).
- 🚀 Atualmente focado em dominar **Python** e arquitetura de **Backend**.
- 🛠️ Desenvolvendo projetos práticos com **SQLite** e lógica de programação.
- ☁️ Interessado em **Cloud Computing (AWS)** e Automação de Processos.
